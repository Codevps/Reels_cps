  ...
  return (
    <div className="w-full flex justify-between border-b-2 border-gray-200 py-2 px-4">
      ...
      <div className="relative hidden md:block">
        ...
        >
          <input
            className="bg-primary p-3 md:text-md font-medium border-2 border-gray-400 focus:outline-none focus:border-2 focus:border-gray-300 w-[300px] md:w-[350px] rounded-full md:top-0"
            type="text"
            value={searchValue}
